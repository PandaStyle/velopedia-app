    ...
    <div class="sidebar" v-bind:class="{'active' : isMenuActive }">
        ...
        <div class="logo-wrapper" v-bind:class="{'active' : isMenuActive }">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                ...
                <path class="path" fill="#000000" d="M35.842,25.315c-9.459,6.936-11.938,18.615-19.177,27.3c1.761,1.891,2.611,2.236,4.839,3.573   c0.203-0.206,0.383-0.394,0.545-0.567c6.512-6.93,9.11-15.623,14.925-22.982c7.222-9.14,19.02-12.646,30.162-14.045   C56.478,16.338,44.631,18.873,35.842,25.315z"></path>
                <path class="path" fill="#000000" d="M72.322,19.607c-0.848-0.259-1.709-0.456-2.574-0.615c-0.866-0.161-1.737-0.296-2.611-0.399l2.572,0.585   c0.853,0.203,1.705,0.405,2.539,0.666c0.834,0.253,1.646,0.58,2.435,0.955c0.397,0.186,0.787,0.386,1.179,0.587   c0.395,0.195,0.781,0.401,1.179,0.592c-0.743-0.476-1.489-0.935-2.27-1.35C73.992,20.209,73.165,19.869,72.322,19.607z"></path></g>
            </svg>
        </div>
